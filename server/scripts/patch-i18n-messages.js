...
const page = {
  ...
  Branches: ["شاخیں", "Shakhein"],
  "Branches (Shakhein)": ["شاخیں", "Shakhein"],
  "Stock In": ["اسٹاک ان", "Stock in"],
  "Stock Out": ["اسٹاک آؤٹ", "Stock out"],
  Transfers: ["ٹرانسفرز", "Transfers"],
  "Transfers between branches": ["شاخوں کے درمیان ٹرانسفر", "Shakhon ke darmiyan transfer"],
  ...
  "Delete branch": ["شاخ ڈیلیٹ کریں", "Shakh delete karein"],
  ...
  "Stock by branch": ["شاخ کے حساب سے اسٹاک", "Shakh ke hisaab se stock"],
  ...
  "Starting quantity at one or more branches (shakhein).": [
    "ایک یا زیادہ شاخوں پر شروع کا اسٹاک۔",
    "Ek ya zyada shakhon par shuru ka stock.",
  ],
  ...
  Search: ["تلاش", "Talash"],
  "Create Branch": ["شاخ بنائیں", "Shakh banayein"],
  "Edit Branch": ["شاخ ایڈٹ کریں", "Shakh edit karein"],
  ...
  "Record wastage": ["بربادی ریکارڈ کریں", "Barbaadi record karein"],
